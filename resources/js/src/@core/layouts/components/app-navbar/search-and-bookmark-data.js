  ...
  pages: {
    ...
    data: [
      ...
      { title: 'Dashboard', route: { name: 'dashboard' }, icon: 'HomeIcon', isBookmarked: false },			
			{ title: 'Volume', route: { name: 'volume' }, icon: 'ListIcon', isBookmarked: false },
      { title: 'Users Edit', route: { name: 'users-edit', params: { id: 21 } }, icon: 'UserIcon', isBookmarked: false },
      { title: 'Users List', route: { name: 'users-list' }, icon: 'UserIcon', isBookmarked: false },
      { title: 'Users View', route: { name: 'users-view', params: { id: 21 } }, icon: 'UserIcon', isBookmarked: false },
			{ title: 'Groups List', route: { name: 'group-list' }, icon: 'UsersIcon', isBookmarked: false },			
      ...
      { title: 'Coming Soon', route: { name: 'coming-soon' }, icon: 'ClockIcon', isBookmarked: false },
      ...
      { title: 'Error', route: { name: 'error' }, icon: 'AlertTriangleIcon', isBookmarked: false },
      ...
      { title: 'Forgot Password V1', route: { name: 'forgot-password-v1' }, icon: 'KeyIcon', isBookmarked: false },
      { title: 'Forgot Password V2', route: { name: 'forgot-password-v2' }, icon: 'KeyIcon', isBookmarked: false },
      ...
      { title: 'Login V1', route: { name: 'login-v1' }, icon: 'LogInIcon', isBookmarked: false },
      { title: 'Login V2', route: { name: 'login-v2' }, icon: 'LogInIcon', isBookmarked: false },
      ...
      { title: 'Register V1', route: { name: 'register-v1' }, icon: 'UserPlusIcon', isBookmarked: false },
      { title: 'Register V2', route: { name: 'register-v2' }, icon: 'UserPlusIcon', isBookmarked: false },
      ...
      { title: 'Under Maintenance', route: { name: 'under-maintenance' }, icon: 'MonitorIcon', isBookmarked: false },
