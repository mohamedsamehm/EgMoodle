  ...
  <component :is="userData === undefined ? 'div' : 'b-card'">
    ...
    >
      ...
      <b-tab>
        ...
        <user-edit-information class="mt-2 pt-75" />
      </b-tab>
      ...
      <b-tab>
        ...
        <user-edit-social class="mt-2 pt-75" />
      </b-tab>
    </b-tabs>
  </component>
</template>
...
export default {
  ...
  setup() {
    ...
    const USER_APP_STORE_MODULE_NAME = 'admin-users'
    ...
    store.dispatch('admin-users/fetchUser', { id: router.currentRoute.params.id })
